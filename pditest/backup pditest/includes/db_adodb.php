<?php /* $Id: db_adodb.php,v 1.24.6.4 2007/11/12 16:15:45 cyberhorse Exp $ */
/*
...
function db_connect( $host='mysqlean.ean.edu.co', $dbname, $user='dbmanager', $passwd='kr56f10qh', $persist=false ) {
