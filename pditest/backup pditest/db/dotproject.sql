...
#   New admin email -> replace {admin@mysqlean.ean.edu.co}
#
...
INSERT INTO `contacts` (contact_id, contact_first_name, contact_last_name, contact_email) 
  VALUES (1,'Admin','Person','admin@mysqlean.ean.edu.co');
...
INSERT INTO `sysvals` ( `sysval_id` , `sysval_key_id` , `sysval_title` , `sysval_value` ) VALUES (null, 2, 'TicketNotify', '0|admin@mysqlean.ean.edu.co\n1|admin@mysqlean.ean.edu.co\n2|admin@mysqlean.ean.edu.co\r\n3|admin@mysqlean.ean.edu.co\r\n4|admin@mysqlean.ean.edu.co');
...
INSERT INTO `config` VALUES (0, 'ldap_host', 'mysqlean.ean.edu.co', 'ldap', 'text'); 
...
INSERT INTO `config` VALUES (0, 'mail_host', 'mysqlean.ean.edu.co', 'mail', 'text');
