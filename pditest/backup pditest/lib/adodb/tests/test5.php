...
if (0) {
	...
	$conn->debug=1;
	$conn->PConnect("mysqlean.ean.edu.co","root","","xphplens");
...
if (0) {
	...
	$conn->debug=1;
	$conn->Connect("mysqlean.ean.edu.co:c:\\Interbase\\Examples\\Database\\employee.gdb", "sysdba", "masterkey", ""); // connect to MySQL, testdb
	print $conn->databaseType.':'.$conn->GenID().'<br>';
}
