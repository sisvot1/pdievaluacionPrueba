...
$pdf->ezText( "\n" . $AppUI->_('Reporte de objetivos que presentan atraso'), 12 );  
if ( $locale_char_set=='utf-8' && function_exists("utf8_decode") ) 
...
$pdfdata = array();
$columns = array();
$columns[] = "<b>" . $AppUI->_('Descripción de la Meta') . "</b>";
// $columns[] = "<b>" . $AppUI->_('Task Name') . "</b>";
$columns[] = "<b>" . $AppUI->_('Líder de la meta') . "</b>";
$columns[] = "<b>" . $AppUI->_('Assigned Users') . "</b>";
if ($hasResources)
	$columns[] = "<b>" . $AppUI->_('Assigned Resources') . "</b>";
$columns[] = "<b>" . $AppUI->_('Fecha finalización') . "</b>";
