...
if($do_report){
    ...
    echo "<tr><th>".$AppUI->_("Meta")."</th><th>".$AppUI->_("Lider de la Meta")."</th><th>".$AppUI->_("Fecha Final de la Meta")."</th><th>".$AppUI->_("Fecha de la ultima Actividad")."</th><th>".$AppUI->_("Hecho")."</th><th>".$AppUI->_("% Cumplimiento")."</th></tr>";
    ...
    foreach($tasks as $task){
        ...
        $done_img = $task["task_percent_complete"] == 100 ? "Si" : "No";
        echo "<tr><td>&nbsp;&nbsp;&nbsp;".$task["task_name"]."</td><td>".$task["user_username"]."</td><td>".$task["task_end_date"]."</td><td>".$task_log["task_log_date"]."</td><td align='center'>$done_img</td><td>".$task["task_percent_complete"]."</td></tr>";
    }
}
?>		
