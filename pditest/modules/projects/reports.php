...
$$project_company= intval(dPgetParam($_REQUEST, '$project_company', 0));
...
<?php echo arraySelect($Companies_list, 'company_id', 'size="1" class="text" onchange="changeIt();"', $company_id, false);?>
